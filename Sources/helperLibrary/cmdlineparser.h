...
public:
    ...
    /*!
     * \brief возвращает "сырую" командную строку
     * \return
     */
    const QString &getSourceCommandLine() const;

private:
    QString m_sourceCommandLine;    ///<"сырая" командная строка, <имя программы> <параметры пользователя...>
